...
#BITMAP'Ы ЖИВОТНЫХ
animals = {
"cat": '', #Кот
...
"lion": "", #Лев
"panda": "", #Панда
"penguin": "", #Пенгвин
"whale": "", #Кит
"sheep": "000000000000000000000000000000000000000000000000000011011100000000110010001101100111100000001001111101000000010111011100000001101111000000000100111000000000010000101001010010000011111111111000001101101111000000000000000000000000000000000000" #Баран
}
#
...
if exists("./data.npy") == False:
    ...
    ChooseAnimal["values"] = ("cat", "horse", "pig", "dog", "hen", "turtle", "rabbit", "koala", "elephant", "beagle", "lion", "panda", "penguin", "whale", "sheep")
    ...
    def __a(e):
        ...
        description = {
            ...
            "lion": ["Он громко рычит","Не большая, он может не есть ~24 часа","Если голодает, то проживёт ~2 часа","Небольшая","Большие, 3 раза в сутки"],
            "panda": ["У неё такие же как и у меня мешки под глазами","Не большая, он может не есть ~24 часа","Если голодает, то проживёт ~2 часа","Нет","Средние, 3 раза в сутки"],
            "penguin": ["TRIGGERED","Не большая, он может не есть ~24 часа","Если голодает, то проживёт ~2 часа","Небольшая","Жидкие кучи, 3 раза в сутки"],
            "whale": ["Самое большое животное","Не большая, он может не есть ~24 часа","Если голодает, то проживёт ~2 часа","Нет","ОГРОМЕННЫЕ, 3 раза в сутки"],
            "sheep": ["Это же бараш","Не большая, он может не есть ~24 часа","Если голодает, то проживёт ~2 часа","Нет","Средние, 3 раза в сутки"]
        }
        c.delete(__a_obj)
